...
public class CompareNames {
    ...
    private static void printComparisonNameResult(String firstName, String secondName) {
        if (firstName.equalsIgnoreCase(secondName))
            System.out.printf("Names are the same");
        int lenghtFirstName = firstName.length();
        int lenghtSecondName = firstName.length();
        if (lenghtFirstName == lenghtSecondName)
            System.out.printf("Length of names are the same");
